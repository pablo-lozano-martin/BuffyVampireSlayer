...
public enum Level 
{
	...
	public int numberVampires()	//Devuelve el número de vampiros totales
	{
		return numberOfVampires;
	}
	
	
	public int dim_x()	//Devuelve las dimensiones del tablero
    {
    	return dim_x;
    }
	...
	public double vampFrequency()	//Devuelve la frecuencia de aparición de vampiros
	{
